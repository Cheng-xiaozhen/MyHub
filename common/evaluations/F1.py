...
@register_evaluator("ImageF1NoRemain")
class ImageF1NoRemain(BaseEvaluator):
...
@register_evaluator("ImageF1")
class ImageF1(BaseEvaluator):
    def __init__(self, threshold=0.5) -> None:
        super().__init__() 
        self.name = "image-level F1"
        self.desc = "image-level F1"
...
@register_evaluator("PixelF1")            
class PixelF1(BaseEvaluator):
