...
@register_evaluator("ImageAUCNoRemain")
class ImageAUCNoRemain(BaseEvaluator):
...
@register_evaluator("ImageAUC")
class ImageAUC(BaseEvaluator):
...
@register_evaluator("PixelAUC")
class PixelAUC(BaseEvaluator):
    # TODO 每张都单独算，不要一起算
